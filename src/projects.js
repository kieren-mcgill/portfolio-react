...
const projects = [
    ...
    },
  {
    ...
    GitHubBack: '',
    Url: 'https://adorable-toffee-5ee04d.netlify.app'
  },
  {
    title: 'Deeper than you Think',
    blurb: "A text-based adventure game written in Java during a pair project, and played in the command line",
    image: 'text-adventure.png',
    GitHubFront: 'https://github.com/kieren-mcgill/java-text-adventure',
    GitHubBack: '',
    Url: ''
  },
  // {
